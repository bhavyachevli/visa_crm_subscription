  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setLeadCode(lead.leadCode || (lead.leadNo ? String(lead.leadNo).padStart(4, '0') : '0001'));
  ...
  return (
    <div className="max-w-5xl mx-auto pb-20">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-sky-900">{leadCode.includes('-') ? leadCode.toUpperCase() : `LEAD-${leadCode.toUpperCase()}`}</h2>
